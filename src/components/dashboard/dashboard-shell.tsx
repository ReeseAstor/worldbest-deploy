...
const navigation = [
  ...
  { name: 'Series Bible', href: '/bible', icon: Users },

  { name: 'Voice Profile', href: '/voice-profile', icon: Fingerprint },
...
const navigation = [
  ...
  { name: 'Series Bible', href: '/dashboard/bible', icon: Users },
  { name: 'Voice Profile', href: '/dashboard/voice-profile', icon: Fingerprint },
